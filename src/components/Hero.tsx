    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 pt-32 pb-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/90 mb-4 animate-fade-up max-w-xl mx-auto" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex items-center justify-center gap-2 text-primary-foreground/80 mb-8 animate-fade-up" style={{ animationDelay: "0.25s" }}>
          ...
          <div className="mt-10 animate-fade-up" style={{ animationDelay: "0.5s" }}>
            <a
              href="#property"
              className="inline-flex flex-col items-center gap-1 text-primary-foreground/70 hover:text-primary-foreground transition-colors animate-bounce"
            >
